...
public struct XVariable
{
    public static CultureInfo Culture = CultureInfo.InvariantCulture;

    public object? Value;

    public XVariable(object value)
    {
        Value = value;
    }
    ...
    public static implicit operator string(XVariable value) => value.Text;
    public static implicit operator XVariable(string value) => new XVariable() { Text = value };
}
